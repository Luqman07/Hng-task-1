...
import profile from '../assets/profile__img.jpg';
import profileHover from '../assets/profileHover.jpg';
  ...
  return (
    <div>
        ...
        <figure className="image" onClick={() => setToggle(!toggle)}>
          <img src={toggle ? profileHover : profile } alt="profile" id='profile__img' />          
        </figure>
        <p id="twitter">Luqman_A007</p>
        <p id="slack">Luqman</p>
      </section>
      ...
      <section className="links-section">
        ...
        <a href='http://books.zuri.team' title="click this link and have unlimited access to large volumes of design and coding books" id='books'>
          <h1>Zuri Books</h1>
        </a>
        <a href='https://books.zuri.team/python-for-beginners?ref_id=Luqman07' title="Want access to unfiltered python knowledge ? Click this link and all will be revealed" id='book__python'>
          <h1>Python Books</h1>
        </a>
        <a href='https://background.zuri.team' title="We take pride in security and here we offer services that allow you know your coders more. Click the link and have full access" id='pitch'>
